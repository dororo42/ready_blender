...
PRO_PRESETS = [
    ...
    {"id": "pro_spots", "name": "斑点 / 豹纹", "params": {"Du": 0.16, "Dv": 0.08, "F": 0.025, "k": 0.060, "dt": 1.0}, "seed_region": "uniform_sparse", "noise_ratio": 1.0, "source": "Karl Sims 经典斑点区"},
    ...
    {"id": "pro_mechanical", "name": "机械 / 齿轮", "params": {"Du": 0.16, "Dv": 0.08, "F": 0.050, "k": 0.064, "dt": 1.0}, "seed_region": "uniform_sparse", "noise_ratio": 1.0, "source": "Karl Sims 经典机械区"},
]



# ── 公式系统的参数变体(净室:文献典型值;GS 的 12 组预设不适用于公式系统) ──
# 注:原 Ready 的 formula 型 pattern 参数命名与其自身公式模型绑定(如 Turing 线性模型
# D_a=0.25/D_b=0.0625/k=0.0625),与本项目 Schnakenberg 非线性实现不通用,故此处
# 采用公开文献典型参数组,不照搬 Ready 文件数值。
FORMULA_VARIANTS = {
    "fitzhugh_nagumo": [
